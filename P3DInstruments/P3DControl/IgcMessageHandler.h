...
public:
	...
	static bool listFiles(Simulator* pSim, const std::string& filter, std::list<std::string>& fileList, std::string& err);
	...
	void listAvailableIGCFiles( Simulator* pSim, const std::string& filter, std::string& output);
